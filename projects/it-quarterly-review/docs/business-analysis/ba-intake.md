...
## 1. Business Outcomes (What success looks like)
- Primary outcome(s):
- Secondary outcome(s):
- KPIs / Metrics (target + current baseline):
...
- Links to documents, spreadsheets, prior reports
- Relevant decisions or approvals
